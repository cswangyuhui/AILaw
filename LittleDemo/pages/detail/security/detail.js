...
Page({
  ...
  askData: function () {
    ...
    if (type == "partNum") {
      ...
      url = 'https://www.服务器域名.site/securitysearch/getLawByChapterNum?chapterNum=' + info.chapternum + '&pageSize=10&pageNum=' + this.data.needpage
    } else if (type == "sectionNum") {
      url = 'https://www.服务器域名.site/securitysearch/getLawByChapterNumAndSectionNum?chapterNum=' + info.chapternum + '&sectionNum=' + info.sectionnum + '&pageSize=10&pageNum=' + this.data.needpage
    } else if (type == 'search') {
      url = encodeURI('https://www.服务器域名.site/securitysearch/getLawByQueryString?queryString=' + info.keywords + '&pageSize=10&pageNum=' + this.data.needpage)
    }
    console.log(url)
