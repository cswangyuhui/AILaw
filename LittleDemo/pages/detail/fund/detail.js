...
Page({
  ...
  askData: function () {
    ...
    if (type == "partNum") {
      ...
      url = 'https://www.服务器域名.site/fundsearch/getFundLawByChapterNum?chapterNum=' + info.chapterNum + '&pageSize=10&pageNum=' + this.data.needpage
      ...
      url = encodeURI('https://www.服务器域名.site/fundsearch/getFundLawByQueryString?queryString=' + info.keywords + '&pageSize=10&pageNum=' + this.data.needpage)
    }
    console.log(url)
