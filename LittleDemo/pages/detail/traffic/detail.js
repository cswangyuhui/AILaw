...
Page({
  ...
  askData: function () {
    ...
    if (type == "partNum") {
      ...
      url = 'https://www.服务器域名.site/trafficsearch/getTrafficByChapterNum?chapterNum=' + info.chapternum + '&pageSize=10&pageNum=' + this.data.needpage
      ...
      url = encodeURI('https://www.服务器域名.site/trafficsearch/getTrafficLawByQueryString?queryString=' + info.keywords + '&pageSize=10&pageNum=' + this.data.needpage)
    }
    console.log(url)
