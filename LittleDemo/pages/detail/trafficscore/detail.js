...
Page({
  ...
  askData: function () {
    ...
    if (type == "partNum") {
      ...
      url = 'https://www.服务器域名.site/trafficscoresearch/getTrafficScoreLawByChapterNum?chapterNum=' + info.chapterNum + '&pageSize=10&pageNum=' + this.data.needpage
      ...
      url = encodeURI('https://www.服务器域名.site/trafficscoresearch/getTrafficScoreLawByQueryString?queryString=' + info.keywords + '&pageSize=10&pageNum=' + this.data.needpage)
    }
    console.log(url)
